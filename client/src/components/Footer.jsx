    ...
    return (
        <footer className='bg-[#F3F6Fa]'>
            <div className='w-[85%] flex flex-wrap mx-auto border-b py-16 md-lg:pb-10 sm:pb-6'>
                <div className='w-3/12 lg:w-4/12 sm:w-full'>
                    <div className='flex flex-col gap-3'>
                        <img className='w-[190px] h-[70x]' src="https://mv-store-client.vercel.app//images/logo.png" alt="logo" />
                        <ul className='flex flex-col gap-2 text-slate-600'>
                            <li>Address : Mymensingh ,Bangladesh</li>
                            <li>Phone : +8801772065894</li>
                            <li>Email : abdullahbinziad@gmail.com</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className='w-4/12 lg:w-full lg:mt-6'>
                    <div className='w-full flex flex-col justify-start gap-5'>
                        ...
                        <div className='h-[50px] w-full bg-white border relative'>
                            ...
                            <button className='h-full absolute right-0 bg-myPrimary text-white uppercase px-4 font-bold text-sm'>Subscribe</button>
                        </div>
            ...
            <div className='w-[85%] flex flex-wrap justify-center items-center text-slate-600 mx-auto py-5 text-center'>
                <span>Copiright ©2023 All rights reserved | Developed by <a href="https://www.linkedin.com/in/abdullahbinziad/" className='text-blue-500 underline' >@ABDULLAH BIN ZIAD</a></span>
            </div>
        </footer>
    )
}
